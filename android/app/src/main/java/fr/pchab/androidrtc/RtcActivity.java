...
//        fullscreenRenderer.setEnableHardwareScaler(true /* enabled */);
    ...
    public void onStartScreensharing(View start_screensharing){
        ...
        Button stop_screensharing = (Button)findViewById(R.id.stop_screensharing);
        stop_screensharing.setVisibility(View.VISIBLE);
        start_screensharing.setVisibility(View.GONE);
    }

    public void onStopScreensharing(View stop_screensharing){
        mWebRtcClient.destroy();
        Button start_screensharing = (Button)findViewById(R.id.start_screensharing);
        start_screensharing.setVisibility(View.VISIBLE);
        stop_screensharing.setVisibility(View.GONE);
    }
